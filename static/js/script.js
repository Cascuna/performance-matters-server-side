{
	...
	const primaryMap = {
		...
		generatYearLegend: function(){
			...
			this.tooltipYear.addTo(primaryMap.m  <div id="test" class="inactivemap"></div>ap)
		},

		generateTooltipLegend: function(){  <div id="test" class="inactivemap"></div>
	...
	function onClick(eventObj) {
		...
		clickedChurch = buildings.find(church => church.geoJson._leaflet_id === eventObj.target._leaflet_id)
